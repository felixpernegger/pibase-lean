...
open Topology TopologicalSpace Filter Set Function
...
/-- Theorem T29: P182 (HasCountableNetwork) => P117 (HasSigmaLocallyFiniteNetwork) -/
instance instHasSigmaLocallyFiniteNetworkOfHasCountableNetwork (X : Type u)
...
instance instHasSigmaLocallyFiniteKNetworkOfHasSigmaLocallyFiniteBasis (X : Type u)
    [TopologicalSpace X] [h : HasSigmaLocallyFiniteBasis X] :
    HasSigmaLocallyFiniteKNetwork X := by
  sorry
...
instance instRadialSpaceOfFrechetUrysohnSpace (X : Type u)
    [TopologicalSpace X] [h : FrechetUrysohnSpace X] :
    RadialSpace X := by
  sorry

/-- Theorem T207: P79 (SequentialSpace) => P173 (PseudoradialSpace) -/
instance instPseudoradialSpaceOfSequentialSpace (X : Type u)
    [TopologicalSpace X] [h : SequentialSpace X] :
    PseudoradialSpace X := by
  sorry
...
/-- Theorem T213: P88 (CollectionwiseNormalSpace) => P13 (NormalSpace) -/
instance instNormalSpaceOfCollectionwiseNormalSpace (X : Type u)
    [TopologicalSpace X] [h : CollectionwiseNormalSpace X] :
    NormalSpace X := by
  sorry
...
/-- Theorem T231: P97 (EmbeddableInR) => P184 (EmbeddableInEuclideanSpace) -/
instance instEmbeddableInEuclideanSpaceOfEmbeddableInR (X : Type u)
    [TopologicalSpace X] [h : EmbeddableInR X] :
    EmbeddableInEuclideanSpace X := by
  sorry
...
/-- Theorem T242: P74 (CosmicSpace) => P177 (SigmaSpace) -/
instance instSigmaSpaceOfCosmicSpace (X : Type u)
    [TopologicalSpace X] [h : CosmicSpace X] :
    SigmaSpace X := by
  sorry

/-- Theorem T243: P179 (AlephZeroSpace) => P178 (AlephSpace) -/
instance instAlephSpaceOfAlephZeroSpace (X : Type u)
    [TopologicalSpace X] [h : AlephZeroSpace X] :
    AlephSpace X := by
  sorry

/-- Theorem T244: P178 (AlephSpace) => P177 (SigmaSpace) -/
instance instSigmaSpaceOfAlephSpace (X : Type u)
...
instance instPerfectlyNormalSpaceOfNormalSpaceOfGδSpace (X : Type u)
    [TopologicalSpace X] [h : NormalSpace X] [h' : GδSpace X] :
    PerfectlyNormalSpace X := by
  sorry

/-- Theorem T259: P57 (Countable) => P182 (HasCountableNetwork) -/
instance instHasCountableNetworkOfCountable (X : Type u)
    [TopologicalSpace X] [h : Countable X] :
    HasCountableNetwork X := by
  sorry
...
instance instHasCountableKNetworkOfSecondCountableTopology (X : Type u)
    [TopologicalSpace X] [h : SecondCountableTopology X] :
    HasCountableKNetwork X := by
  sorry
...
-- Most likely redundant
/-- Theorem T320: P40 (UltraconnectedSpace) => P189 (SigmaConnectedSpace) -/
instance instSigmaConnectedSpaceOfUltraconnectedSpace (X : Type u)
    [TopologicalSpace X] [h : UltraconnectedSpace X] :
...
instance instPSpaceOfAlexandrovDiscrete (X : Type u)
    [TopologicalSpace X] [h : AlexandrovDiscrete X] :
    PSpace X := by
  sorry
...
/-- Theorem T356: P153 (OmegaMengerSpace) => P149 (OmegaLindelof) -/
instance instOmegaLindelofOfOmegaMengerSpace (X : Type u)
...
instance instOmegaMengerSpaceOfOmegaRothberger (X : Type u)
    ...
    OmegaMengerSpace X := by
  sorry

/-- Theorem T360: P149 (OmegaLindelof) => P18 (LindelofSpace) -/
instance instLindelofSpaceOfOmegaLindelof (X : Type u)
    [TopologicalSpace X] [h : OmegaLindelof X] :
    LindelofSpace X := by
  sorry
...
/-- Theorem T377: P136 (AnticompactSpace) + P149 (OmegaLindelof) => P128 (KLindelofSpace) -/
instance instKLindelofSpaceOfAnticompactSpaceOfOmegaLindelof (X : Type u)
    [TopologicalSpace X] [h : AnticompactSpace X] [h' : OmegaLindelof X] :
    KLindelofSpace X := by
  sorry
...
instance instSubmetrizableSpaceOfMetrizableSpace (X : Type u)
    [TopologicalSpace X] [h : MetrizableSpace X] :
    SubmetrizableSpace X := by
  sorry
...
instance instHasDispersionPointOfPreconnectedSpaceOfNotCardGeThreeOfNonempty (X : Type u)
    [TopologicalSpace X] [h : PreconnectedSpace X] (h2 : ¬ CardGeThree X) [h' : Nonempty X] :
    HasDispersionPoint X := by
  sorry
...
instance instCompactSpaceOfCorsonCompactSpace (X : Type u)
    [TopologicalSpace X] [h : CorsonCompactSpace X] :
    CompactSpace X := by
  sorry
...
instance instLOTSOfOrdinalSpace (X : Type u)
    [TopologicalSpace X] [h : OrdinalSpace X] :
    LOTS X := by
  sorry
...
instance instBasicallyDisconnectedSpaceOfExtremallyDisconnected (X : Type u)
    ...
    BasicallyDisconnectedSpace X := by
  sorry
...
instance instExtremallyDisconnectedOfBasicallyDisconnectedSpaceOfPerfectlyNormalSpace (X : Type u)
    [TopologicalSpace X] [h : BasicallyDisconnectedSpace X] [h' : PerfectlyNormalSpace X] :
...
/-- Theorem T832: P226 (ArtinianSpace) => P180 (HereditarilySeparableSpace) -/
instance instHereditarilySeparableSpaceOfArtinianSpace (X : Type u)
...
instance instSemilocallySimplyConnectedSpaceOfWeaklyLocallySimplyConnectedSpace (X : Type u)
