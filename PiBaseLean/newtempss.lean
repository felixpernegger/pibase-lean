...
public import PiBaseLean.Properties.P6.Lemmas
...
public import PiBaseLean.Properties.P11.Lemmas
...
public import PiBaseLean.Properties.P19.Lemmas
...
public import PiBaseLean.Properties.P50.Lemmas
...
public import PiBaseLean.Properties.P177.Lemmas
public import PiBaseLean.Properties.P178.Lemmas
public import PiBaseLean.Properties.P179.Lemmas
...
public import PiBaseLean.Properties.P184.Lemmas
...
public import PiBaseLean.Properties.P190.Lemmas
...
public import PiBaseLean.Properties.P196.Lemmas
...
=> P5 (T3Space) -/
instance instT3SpaceOfT2SpaceOfCountablyCompactSpaceOfFirstCountableTopology (X : Type u)
    [TopologicalSpace X] [T2Space X] [CountablyCompactSpace X] [FirstCountableTopology X] :
    T3Space X := by
  sorry
...
instance instTotallyDisconnectedSpaceOfT1SpaceOfScatteredSpace (X : Type u)
    [TopologicalSpace X] [T1Space X] [ScatteredSpace X] : TotallyDisconnectedSpace X := by
  sorry
...
instance instFunctionallyT2SpaceOfTotallySeparatedSpace (X : Type u)
    [TopologicalSpace X] [TotallySeparatedSpace X] : FunctionallyT2Space X := by
  sorry
...
instance instIsCompletelyMetrizableSpaceOfWeaklyLocallyCompactSpaceOfMetrizableSpace
    (X : Type u) [TopologicalSpace X] [WeaklyLocallyCompactSpace X] [MetrizableSpace X] :
...
instance instSeqCompactSpaceOfCountablyCompactSpaceOfSequentialSpace (X : Type u)
    [TopologicalSpace X] [CountablyCompactSpace X] [SequentialSpace X] : SeqCompactSpace X := by
  sorry

/-- Theorem T258: P11 (RegularSpace) + P131 (HereditarilyLindelofSpace)
=> P15 (PerfectlyNormalSpace) -/
instance instPerfectlyNormalSpaceOfRegularSpaceOfHereditarilyLindelofSpace (X : Type u)
    [TopologicalSpace X] [RegularSpace X] [HereditarilyLindelofSpace X] :
...
instance instSeqCompactSpaceOfCompactSpaceOfCountable (X : Type u)
    [TopologicalSpace X] [CompactSpace X] [Countable X] : SeqCompactSpace X := by
  sorry

/-- Theorem T514: P192 (QuasiSober) + P39 (PreirreducibleSpace) + P135 (R0Space)
=> P129 (IndiscreteTopology) -/
...
/-- Theorem T806: P16 (CompactSpace) + P131 (HereditarilyLindelofSpace) => P20 (SeqCompactSpace) -/
instance instSeqCompactSpaceOfCompactSpaceOfHereditarilyLindelofSpace (X : Type u)
    [TopologicalSpace X] [CompactSpace X] [HereditarilyLindelofSpace X] : SeqCompactSpace X := by
  sorry
