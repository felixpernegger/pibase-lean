...
The [API documentation](https://felixpernegger.github.io/pibase-lean/docs/) generated by doc-gen4 is published alongside it.
Both are built and deployed together by the `Deploy project site to Pages` workflow on every push to `master`.
